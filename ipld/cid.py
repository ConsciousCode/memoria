...
class CID:
    ...
    @staticmethod
    def unparse(version: Version, codec: Codec, multihash: str|bytes|Multihash) -> bytes:
        """
...
class CIDv0(CID):
    ...
    @overload
    def __new__(cls, /, version: int, multihash: str|bytes) -> Self: ...
    @overload
    def __new__(cls, /, version: int, codec: Codec, multihash: str|bytes) -> Self: ...
